        ...
        if(tjColumnHead.getType()==TjColumnHead.TYPE_NEW_GAME_SF){
            ...
            holder.tvMore.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    GameListActivity.start(v.getContext(), holder.tvTypeName.getText().toString(),0,2,0,0,0,0,null);
                }
            });
            ...
            holder.tvMore.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    GameListActivity.start(v.getContext(), holder.tvTypeName.getText().toString(),0,0,0,0,0,2,null);
                }
            });
